...
public class EmployeeController {
    ...
    static {
        ...
        listEmployee.add(new Employee(1, "Hieu", 21, 10000));
        listEmployee.add(new Employee(2, "An", 23, 20000));
        listEmployee.add(new Employee(3, "Hung", 24, 30000));
        listEmployee.add(new Employee(4, "Luyen", 26, 40000));
        listEmployee.add(new Employee(5, "Nhat", 25, 50000));
    }
